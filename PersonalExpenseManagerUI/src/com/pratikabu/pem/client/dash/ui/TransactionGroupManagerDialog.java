 ...
 *
 */
public class TransactionGroupManagerDialog extends DialogBox {
	
	private static TransactionGroupManagerDialog ac;
	...
	public static TransactionGroupManagerDialog get() {
		if(null == ac) {
			ac = new TransactionGroupManagerDialog();
		}
		
		return ac;
	}
	
	private TransactionGroupManagerDialog() {
		initializeObjects();
		placeObjects();
	}
